...
Launch Browser
    ...
    common.logixspage.robotin  ${qa_ui_url}  ${qa_username}  ${qa_password}

Navigate To IXS Page
    [Documentation]     Once browser is opne, navigate to ixs page
    [Tags]      Mam page test

    ixspage.Goto IXS Page
    ixspage.Search For Item   ${program_search}
